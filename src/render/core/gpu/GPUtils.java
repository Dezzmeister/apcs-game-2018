...
public class GPUtils {
	...
	public static float[] rayHitSegment(float rayStartX, float rayStartY, float rayDirectionX, float rayDirectionY, float wallv0x, float wallv0y, float wallv1x, float wallv1y) {		
		float s1x;
		float s1y;
		float s2x;
		float s2y;
