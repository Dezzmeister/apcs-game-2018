...
public class Vector3 {
	...
	/**
	 * This constructor is used by <code>normalize()</code> to avoid overhead
	 * from <code>updateLength()</code>, because a Vector returned by <code>normalize</code>
	 * is guaranteed to have a length of 1.
	 * <p>
	...
	/**
	 * This method should be called by the user to update the length of the Vector. This kind of control
	 * is given to the user to ensure that this class is as fast as possible. As a result, the user
	 * must be responsible and know when they need to update the length before an operation.
	 */
