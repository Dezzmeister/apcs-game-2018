...
/**
 * Four {@link Vector3}'s define the corners of a 4-edged LightPlane, which contains lightmap data. This fits our Raycaster
 * since every tile/face has 4 edges.
 *
 * @author Joe Desmond
 */
public final class LightPlane {
	 ...
	 * @param _v3 Fourth vertex
	 * @param _resWidth x-resolution of the lightplane, in lumels
	 * @param _resHeight y-resolution of the lightplane, in lumels
	 */
	...
	/**
	 * Creates a 3D LightPlane for a ceiling tile located at (x,y) with a resolution of
	 * <code>squareResolution</code> by <code>squareResolution</code> lumels. LightPlanes for floor and
	 * ceiling tiles should be generated for fake/<code>SPACE</code> Blocks.
	 * 
	 * @param x x coordinate of the ceiling tile
	 * @param y y coordinate of the ceiling tile
	 * @param squareResolution resolution of the LightPlane, in lumels
	...
	/**
	 * Creates a 3D LightPlane for a floor tile located at (x,y) with a resolution of
	 * <code>squareResolution</code> by <code>squareResolution</code> lumels. LightPlanes for floor and
	 * ceiling tiles should be generated for fake/<code>SPACE</code> Blocks.
	 * 
	 * @param x x coordinate of the floor tile
	 * @param y y coordinate of the floor tile
	 * @param squareResolution resolution of both sides of the LightPlane, in lumels
	...
	/**
	 * Creates a 3D LightPlane for the side of a {@link render.core.Block Block} facing the positive x direction, at
	 * the location (x,y) with a resolution of <code>squareResolution</code> by <code>squareResolution</code>
	 * lumels.
	 * 
	...
	/**
	 * Creates a 3D LightPlane for the side of a {@link render.core.Block Block} facing the negative x direction, at
	 * the location (x,y) with a resolution of <code>squareResolution</code> by <code>squareResolution</code>
	 * lumels.
	 * 
	 * @param x x coordinate of the Block
	...
	/**
	 * Creates a 3D LightPlane for the side of a {@link render.core.Block Block} facing the negative y direction, at
	 * the location (x,y) with a resolution of <code>squareResolution</code> by <code>squareResolution</code>
	 * lumels.
	 * 
	 * @param x x coordinate of the Block
	...
	/**
	 * Creates a 3D LightPlane for the side of a {@link render.core.Block Block} facing the positive y direction, at
	 * the location (x,y) with a resolution of <code>squareResolution</code> by <code>squareResolution</code>
	 * lumels.
	 * 
	 * @param x x coordinate of the Block
	...
	/**
	 * Creates a 3D LightPlane for a {@link render.core.Wall Wall}. <code>verticalLumels</code> defines the vertical component of the
	 * resolution in lumels; the horizontal component is calculated to ensure square lumels. <b>BEWARE: two
	 * sides of a Wall may need different LightPlanes!</b>
	 * 
	 * @param wall
