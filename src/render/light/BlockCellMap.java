...
public class BlockCellMap extends CellMap {
	 ...
	 * 
	 * @param x x position of the Block in the world
	 * @param y y position of the Block in the world
	...
	/**
	 * Returns the LightPlane corresponding to the side of a Block facing positive x.
	 * 
	...
	/**
	 * Returns the LightPlane corresponding to the side of a Block facing negative x.
	 * 
	...
	/**
	 * Returns the LightPlane corresponding to the side of a Block facing positive y.
	 * 
	...
	/**
	 * Returns the LightPlane corresponding to the side of a Block facing negative y.
	 * 
