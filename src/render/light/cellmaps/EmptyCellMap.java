...
/**
 * Contains lightmap information for an empty {@link render.core.Block Block}.
 * Has 2 {@link LightPlane LightPlanes}, one for the floor and one for the
 * ceiling.
 *
 * @author Joe Desmond
 */
public class EmptyCellMap extends CellMap {
	...
	/**
	 * Creates two empty LightPlanes from an x and y value of an empty cell and a
	 * resolution for each side of each plane.
	 *
	 * @param x
	 ...
	 *            resolution of each side of each LightPlane, in lumels
	 */
