...
/**
 * A ViewModel that has an idle state, a primary state, and a secondary state.
 * When this ViewModel is in one of its states, it will play the corresponding
 * animation, provided <code>update()</code> is called regularly. ViewModel also
 * supports the addition of more states and animations that can be activated by
...
public class ViewModel {
	...
	/**
	 * Returns true if the action was successful; the state's animation could be
	 * started.
	 *
	 * @return true if the animation was started successfully; false if the state
	 *         does not exist or the animation could not be started
	 */
