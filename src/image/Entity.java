...
public abstract class Entity implements Comparable<Entity> {
	...
	/**
	 * Returns the active {@link SquareTexture} for this Entity. For items, this texture is constant; for
	 * actors, this texture should change to show a different view of an Entity.
	 * 
